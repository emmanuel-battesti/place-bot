...
Installation on **macOS systems** is challenging and is **not officially supported**. *Place-Bot* requires a recent version of *OpenGL* to function properly. However, recent versions of macOS no longer use *OpenGL* and instead rely on Apple's *Metal* graphics framework.
...
*Place-Bot* requires **Python 3.8 or higher**. Python 3.8 is the default version on Ubuntu 20.04.
...
Download the code from [*Place-Bot*](https://github.com/emmanuel-battesti/place-bot):

```bash
git clone https://github.com/emmanuel-battesti/place-bot.git
```

This creates the *place-bot* directory with all the source code.
...
Git is essential for source code management and tracking changes in the *place-bot* project.
...
Clone the code from [*Place-Bot*](https://github.com/emmanuel-battesti/place-bot):
...
*Place-Bot* requires OpenGL 4.40 or higher. Use this script to verify your system:
```bash
python src/place_bot/tools/opengl_info.py
```
