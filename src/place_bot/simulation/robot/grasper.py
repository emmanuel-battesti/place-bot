...
from place_bot.simulation.robot.controller import GrasperController
from place_bot.simulation.robot.device import Device
from place_bot.simulation.elements.wounded_person import WoundedPerson
...
class Grasper(Device):
    ...
    def __init__(
            self, anchor: RobotPart, max_grasped: Optional[int] = None, **kwargs
    ):
        """
        Initialize the Grasper.

        Args:
            anchor (RobotPart): The robot part to attach the grasper to.
